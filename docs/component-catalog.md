...
|------|-----------|---------|---------|
| `/viktor:think` | `skills/01-brainstorming/SKILL.md` | 需求澄清，苏格拉底式提问，输出 specs/ 设计文档 | v0.1.0 |
...
| `/viktor:init` | `skills/06-project-init/SKILL.md` | 项目知识地图扫描，生成 project-context.md 和活文档骨架 | v0.1.0 |
